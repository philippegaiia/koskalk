...
## Generate English guidance before localization
Full ingredient enrichment and ordinary guidance refresh stop after producing reviewable English guidance; they must not invoke or apply localization. After the saved English is proofread, the Guidance & media “Update translations” action starts a GuidanceLocalization batch from canonical English. Localization-only uses its dedicated model and reasoning effort, preserves reviewer-owned locale guidance, and updates only missing or stale AI locales.
