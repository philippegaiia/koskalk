...
@theme {
    ...
    /* ── Surfaces ── */
    --color-surface:        oklch(97.5% .008 82);   /* Warm Stone — page background */
    --color-panel:          oklch(99.5% .003 80);   /* Lifted white — primary cards */
    --color-panel-strong:   oklch(93.5% .014 80);   /* Recessed inset — inner zones, rows */

    /* ── Sidebar ── */
    --color-hero:           oklch(22.0% .025 154);  /* Deep forest — sidebar bg */
    --color-hero-soft:      oklch(27.0% .028 154);  /* Sidebar hover state */
    --color-surface-strong: oklch(30.0% .022 80);   /* Dark overlay */

    /* ── Borders / lines ── */
    --color-line:           oklch(88% .010 80);
    --color-line-strong:    oklch(72% .018 80);
    --color-line-hero:      oklch(40% .030 154);    /* Borders inside sidebar */

    /* ── Text ── */
    --color-ink:            oklch(28% .012 75);     /* Body text — warm near-black */
    --color-ink-strong:     oklch(13% .008 70);     /* Titles — darkest */
    --color-ink-soft:       oklch(54% .012 75);     /* Labels, secondary, metadata */

    /* ── Sidebar text ── */
    --color-ink-sidebar:    oklch(88% .020 154);
    --color-ink-sidebar-soft: oklch(62% .028 154);

    /* ── Primary Accent — Deep Sage ── */
    --color-accent:         oklch(46% .115 154);    /* CTAs and active states ONLY */
    --color-accent-hover:   oklch(38% .105 154);
    --color-accent-soft:    oklch(94% .036 154);    /* Badge bg — hydration/water */
    --color-accent-strong:  oklch(32% .092 154);    /* Badge text — hydration/water */

    /* ── Tertiary Amber — alkaline components (NaOH / KOH) ── */
    --color-warning:        oklch(46% .110 55);
    --color-warning-hover:  oklch(38% .100 55);
    --color-warning-soft:   oklch(93% .038 68);     /* Badge bg — alkaline */
    --color-warning-strong: oklch(36% .095 55);     /* Badge text — alkaline */

    /* ── Danger — high-risk metrics, errors ── */
