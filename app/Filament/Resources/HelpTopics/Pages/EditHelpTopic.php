...
class EditHelpTopic extends EditRecord
{
    ...
    public function editorReference(): array
    {
        ...
        return [
            ...
            'locations' => [...app(WorkbenchHelpTopics::class)->locations($this->getRecord()->key), ...app(InventoryHelpTopics::class)->locations($this->getRecord()->key), ...app(PurchasingHelpTopics::class)->locations($this->getRecord()->key)],
