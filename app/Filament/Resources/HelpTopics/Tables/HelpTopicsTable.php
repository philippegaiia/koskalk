...
class HelpTopicsTable
{
    public static function configure(Table $table): Table
    {
        return $table->columns([
            ...
            SelectFilter::make('domain')->options(['shared_workbench' => 'Shared workbench', 'soap_workbench' => 'Soap workbench', 'cosmetic_workbench' => 'Cosmetic workbench', 'production_inventory' => 'Production inventory', 'production_purchasing' => 'Production purchasing']),
