...
class ProductionLocationPolicy
{
    ...
    public function view(User $user, ProductionLocation $location): bool
    {
    ...
    public function update(User $user, ProductionLocation $location): bool
    {
        $workspace = $location->workspace;
    ...
    public function delete(User $user, ProductionLocation $location): bool
    {
        return false;
    }

    public function restore(User $user, ProductionLocation $location): bool
    {
        return false;
    }

    public function forceDelete(User $user, ProductionLocation $location): bool
    {
        return false;
    }
}
