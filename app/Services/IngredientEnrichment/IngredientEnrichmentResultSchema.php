    ...
    public function build(?array $record = null): array
    {
        ...
        return $this->object([
            ...
            'guidance_evidence' => $this->array($this->object([
                ...
                'claim_type' => $this->string(enum: config('ingredient-enrichment.openai.guidance_research.allowed_claim_types')),
                'source_kind' => $this->string(enum: config('ingredient-enrichment.openai.guidance_research.allowed_source_kinds')),
                'scope' => $this->string(enum: config('ingredient-enrichment.openai.guidance_research.allowed_scopes')),
                'evidence_kind' => $this->string(enum: config('ingredient-enrichment.openai.guidance_research.allowed_evidence_kinds')),
                'usage_application' => $this->string(enum: config('ingredient-enrichment.openai.guidance_research.allowed_usage_applications')),
                'recommended_min_percent' => $this->nullableString(),
                'recommended_max_percent' => $this->nullableString(),
                'percentage_basis' => $this->string(enum: config('ingredient-enrichment.openai.guidance_research.allowed_percentage_bases')),
            ])),
