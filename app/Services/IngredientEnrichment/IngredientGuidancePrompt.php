...
9. Write natural ingredient-level prose. Keep supplier names, manufacturer names, brands, product codes, source kinds, and evidence-schema labels in the evidence record. Use a grade description in prose only when the distinction itself is essential to safe or correct use.
