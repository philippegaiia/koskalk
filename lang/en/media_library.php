...
return [
    ...
    'open_image_for' => 'Open :name in a new tab',
    'open_pdf' => 'Open PDF',
    'open_pdf_for' => 'Open :name as a PDF in a new tab',
    'selected_files' => '{1} :count file selected|[2,*] :count files selected',
    'upload_selected' => 'Upload selected files',
    'batch_completed' => '{1} :count file uploaded. Previews are being prepared.|[2,*] :count files uploaded. Previews are being prepared.',
    'batch_failed' => '{1} :count file could not be uploaded. Retry it below.|[2,*] :count files could not be uploaded. Retry them below.',
    ...
    'search' => 'Search',
    'picker' => [
        'upload_selected' => 'Upload ready and selected. Save the form to apply your selection.',
        'upload_available' => 'Upload ready in your library. Select it when you have room in your selection.',
        ...
        'clear' => 'Remove from form',
        'close' => 'Close media picker',
        'library' => 'Library',
        'upload_new' => 'Upload new',
        'upload_new_document' => 'Upload document',
        'upload' => 'Upload',
        ...
        'select_documents' => 'Select up to :count ready documents.',
        ...
        'empty_documents_description' => 'Upload a document to the library, then return here to select it.',
        ...
        'processing_document' => 'Processing uploaded document',
    ...
    'panel' => [
        ...
        'save_failed' => 'Changes were not saved. Review the fields and try again.',
        'discard_prompt' => 'Discard your unsaved changes?',
        'keep_editing' => 'Keep editing',
        'discard' => 'Discard and close',
        'new_label_help' => 'New labels stay in your library. Save changes to apply them to this file.',
        'settings' => 'Settings',
    ...
    'empty' => [
        'start' => 'Upload images or documents to start your library.',
    ...
    'validation' => [
        ...
        'maximum_documents' => 'Choose up to :max documents.',
