    ...
    <body class="flex min-h-screen flex-col overflow-x-hidden bg-cream font-sans text-ink-strong antialiased @yield('body_class')">
        ...
        <nav class="sk-shell-line-b fixed top-0 left-0 right-0 z-50 h-[58px] bg-cream/92 backdrop-blur-[10px]">
            <div data-public-nav-inner class="mx-auto flex h-full w-full max-w-[1180px] items-center justify-between gap-3 px-4 min-[390px]:px-5 lg:gap-6 lg:px-10">
                ...
                <div class="hidden md:flex gap-8 items-center">
                    <a href="{{ route('home') }}#calculator" class="text-sm text-ink-soft no-underline transition hover:text-ink-strong">Calculator</a>
                    <a href="{{ route('home') }}#benefits" class="text-sm text-ink-soft no-underline transition hover:text-ink-strong">Benefits</a>
                    <a href="{{ route('home') }}#workspace" class="text-sm text-ink-soft no-underline transition hover:text-ink-strong">Workspace</a>
                    <a href="{{ route('home') }}#comparison" class="text-sm text-ink-soft no-underline transition hover:text-ink-strong">Why Soapkraft</a>
                </div>
        ...
        <div id="mobile-menu" data-mobile-menu class="sk-shell-line-b fixed top-[58px] left-0 right-0 z-40 hidden bg-cream px-5 py-4 md:hidden">
            <div class="flex flex-col gap-1">
                <a href="{{ route('home') }}#calculator" class="rounded-lg px-4 py-3 text-sm text-ink-soft no-underline transition hover:bg-panel hover:text-ink-strong">Calculator</a>
                <a href="{{ route('home') }}#benefits" class="rounded-lg px-4 py-3 text-sm text-ink-soft no-underline transition hover:bg-panel hover:text-ink-strong">Benefits</a>
                <a href="{{ route('home') }}#workspace" class="rounded-lg px-4 py-3 text-sm text-ink-soft no-underline transition hover:bg-panel hover:text-ink-strong">Workspace</a>
                <a href="{{ route('home') }}#comparison" class="rounded-lg px-4 py-3 text-sm text-ink-soft no-underline transition hover:bg-panel hover:text-ink-strong">Why Soapkraft</a>
            </div>
        </div>
        ...
        <footer class="sk-shell-line-t bg-panel py-8">
            <div data-public-footer-inner class="mx-auto flex w-full max-w-[1180px] flex-col items-center justify-between gap-4 px-5 text-center lg:flex-row lg:px-10 lg:text-left">
                ...
                <div class="flex flex-wrap justify-center gap-x-5 gap-y-2 min-[390px]:gap-x-7">
                    <a href="{{ route('home') }}#calculator" class="inline-flex min-h-11 items-center rounded px-1 py-2 text-sm font-medium text-ink-soft no-underline transition hover:text-ink-strong">Calculator</a>
                    <a href="{{ route('home') }}#workspace" class="inline-flex min-h-11 items-center rounded px-1 py-2 text-sm font-medium text-ink-soft no-underline transition hover:text-ink-strong">Workspace</a>
                    <a href="{{ route('home') }}#benefits" class="inline-flex min-h-11 items-center rounded px-1 py-2 text-sm font-medium text-ink-soft no-underline transition hover:text-ink-strong">Benefits</a>
