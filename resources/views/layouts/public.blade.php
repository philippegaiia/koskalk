...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <body class="min-h-screen bg-cream text-ink-strong antialiased overflow-x-hidden" style="font-family: 'DM Sans', sans-serif;">
        ...
        {{-- NAV --}}
        <nav class="fixed top-0 left-0 right-0 z-50 h-[58px] bg-cream/92 backdrop-blur-[10px] border-b border-line">
            <div data-public-nav-inner class="mx-auto flex h-full w-full max-w-[1180px] items-center justify-between gap-6 px-5 lg:px-10">
                ...
                <div class="hidden md:flex gap-8 items-center">
                    ...
                    <a href="#workspace" class="text-[13px] text-ink-soft no-underline transition hover:text-ink-strong">Workspace</a>
        ...
        {{-- FOOTER --}}
        <footer class="bg-panel border-t border-line py-8">
            <div data-public-footer-inner class="mx-auto flex w-full max-w-[1180px] flex-col items-center justify-between gap-4 px-5 lg:flex-row lg:px-10">
                <p class="font-serif text-sm text-ink-soft">Soapkraft — free soap calculator · soap & cosmetic formulation workspace</p>
