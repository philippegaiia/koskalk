<div class="mx-auto w-full max-w-7xl space-y-6">
    <section class="rounded-[2rem] border border-[var(--color-line)] bg-white p-5 sm:p-6">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div class="min-w-0">
                ...
                <h3 class="mt-2 max-w-4xl text-xl font-semibold tracking-[-0.03em] text-[var(--color-ink-strong)] sm:text-2xl">Search and maintain your reusable packaging catalog.</h3>
    ...
    @else
        <section class="overflow-hidden rounded-[2rem] border border-[var(--color-line)] bg-white p-0">
            {{ $this->table }}
        </section>
    @endif
</div>
