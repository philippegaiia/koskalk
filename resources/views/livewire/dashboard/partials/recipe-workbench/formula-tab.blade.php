...
<div x-show="activeWorkbenchTab === 'formula'" role="tabpanel" aria-labelledby="tab-formula" id="panel-formula" class="space-y-6 pb-40 sm:pb-28">
 ...
 >
 <div class="order-1 min-w-0 @5xl/workbench:col-start-1 @5xl/workbench:row-start-1 space-y-4 @5xl/workbench:sticky @5xl/workbench:top-4 @5xl/workbench:self-start">
