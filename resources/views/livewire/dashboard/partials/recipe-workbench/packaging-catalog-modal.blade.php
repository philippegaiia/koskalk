...
>
 ...
 <button type="button" @click="savePackagingCatalogItemAndAdd()" class="rounded-full bg-[var(--color-accent)] px-4 py-2 text-sm font-medium text-white transition hover:bg-[var(--color-accent-hover)]">
