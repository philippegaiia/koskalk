        ...
        <div class="space-y-5 p-5">
            <div class="overflow-hidden rounded-[1.75rem] border border-[var(--color-line)]">
                <div class="border-b border-[var(--color-line)] px-4 py-3">
                    ...
                    <p class="mt-1 text-xs text-[var(--color-ink-soft)]">Colorants, preservatives, and other post-reaction functional materials. Drag to reorder, or move compatible carrier oils here after the reaction core.</p>
                </div>
                ...
                <div class="divide-y divide-[var(--color-line)] bg-white">
                    ...
                    <div @dragover="allowPhaseDrop('additives', $event)"
                        ...
                        <span x-show="additiveRows.length > 0">Drag here to place an ingredient at the end of additives.</span>
                        <span x-show="additiveRows.length === 0">Drop a compatible ingredient here to start the additives phase.</span>
                    </div>
                </div>
            </div>
                ...
                <div class="overflow-hidden rounded-[1.75rem] border border-[var(--color-line)]">
                    ...
                    <div class="divide-y divide-[var(--color-line)] bg-white">
                        ...
                        <div @dragover="allowPhaseDrop('fragrance', $event)"
                            ...
                            class="px-4 py-2 text-xs font-medium transition">
                            Drag here to place an aromatic ingredient at the end of the phase.
                        </div>
                    </div>
                </div>
            </template>
