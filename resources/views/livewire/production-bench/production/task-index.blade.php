<x-production-bench.page active="tasks">
    ...
    <section aria-label="{{ __('production_bench.common.filters') }}" class="sk-card space-y-4 p-5">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            <label class="text-sm lg:col-span-2"><span class="font-medium">{{ __('production_bench.common.search') }}</span><input autocomplete="off" wire:model.live.debounce.300ms="search" class="sk-input mt-1 w-full" placeholder="{{ __('production_bench.production.task_search_placeholder') }}"></label>
