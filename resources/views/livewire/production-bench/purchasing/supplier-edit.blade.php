    ...
    <form wire:submit="save" class="space-y-4 pb-24">
        ...
        >
            <div class="mx-auto flex max-w-5xl items-center justify-end gap-4">
                <a href="{{ route('production-bench.purchasing.supplier', $supplier) }}" wire:navigate class="pointer-events-auto text-sm font-medium text-[var(--color-ink-soft)] hover:text-[var(--color-ink-strong)]">Cancel</a>
