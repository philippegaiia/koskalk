...
<div class="space-y-6">
    <section class="grid gap-4 lg:grid-cols-4">
        @foreach ($summaryCards as $card)
            <article class="rounded-xl bg-[var(--color-panel)] shadow-[0_2px_4px_rgba(60,50,30,0.04),0_12px_24px_rgba(60,50,30,0.08)] p-4">
                <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">{{ $card['label'] }}</p>
    ...
    <section class="grid gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
        <article class="rounded-xl bg-[var(--color-panel)] shadow-[0_2px_4px_rgba(60,50,30,0.04),0_12px_24px_rgba(60,50,30,0.08)] p-5">
            <div class="flex items-center justify-between gap-3">
                <div>
                    <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">Formula context</p>
            ...
            <div class="mt-4 grid gap-3 sm:grid-cols-2">
                @foreach ($contextRows as $row)
                    <div class="rounded-lg bg-[var(--color-panel-strong)] px-4 py-3">
                        <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">{{ $row['label'] }}</p>
        ...
        <article class="rounded-xl bg-[var(--color-panel)] shadow-[0_2px_4px_rgba(60,50,30,0.04),0_12px_24px_rgba(60,50,30,0.08)] p-5">
            <div>
                <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">Lye and water</p>
    ...
    <section class="space-y-4">
        @foreach ($phaseSections as $section)
            <article class="overflow-hidden rounded-xl bg-[var(--color-panel)] shadow-[0_2px_4px_rgba(60,50,30,0.04),0_12px_24px_rgba(60,50,30,0.08)]">
                <div class="border-b border-[var(--color-line)] px-5 py-4">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">{{ $section['label'] }}</p>
                            <p class="mt-1 text-sm text-[var(--color-ink-soft)]">Percentages locked to the saved formula. Only the oil quantity basis changes.</p>
                        </div>
    ...
    @if ($recipe->description)
        <section class="rounded-xl bg-[var(--color-panel)] shadow-[0_2px_4px_rgba(60,50,30,0.04),0_12px_24px_rgba(60,50,30,0.08)] p-5">
            <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">Presentation</p>
    ...
    @if ($recipe->manufacturing_instructions)
        <section class="rounded-xl bg-[var(--color-panel)] shadow-[0_2px_4px_rgba(60,50,30,0.04),0_12px_24px_rgba(60,50,30,0.08)] p-5">
            <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">Manufacturing instructions</p>
            <div class="prose prose-stone mt-4 max-w-none text-[var(--color-ink-soft)]">
    ...
    @if ($showDetails)
        <section class="rounded-xl bg-[var(--color-panel)] shadow-[0_2px_4px_rgba(60,50,30,0.04),0_12px_24px_rgba(60,50,30,0.08)] p-5">
            ...
            @if ($listVariants !== [])
                <div class="mt-4 grid gap-4 xl:grid-cols-2">
                    @foreach ($listVariants as $variant)
                        <div class="rounded-lg bg-[var(--color-panel-strong)] px-4 py-3">
                            <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">{{ $variant['label'] }}</p>
            ...
            @else
                <div class="mt-4 rounded-lg bg-[var(--color-panel-strong)] px-4 py-3 text-[0.98rem] leading-8 font-medium tracking-[0.01em] [font-stretch:88%] text-[var(--color-ink-strong)]">
        ...
        <section class="overflow-hidden rounded-xl bg-[var(--color-panel)] shadow-[0_2px_4px_rgba(60,50,30,0.04),0_12px_24px_rgba(60,50,30,0.08)]">
            <div class="border-b border-[var(--color-line)] px-5 py-4">
                <p class="text-[0.6875rem] font-medium tracking-[0.05em] text-[var(--color-ink-soft)] uppercase">Declaration details</p>
