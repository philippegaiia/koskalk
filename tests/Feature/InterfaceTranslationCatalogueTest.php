...
it('keeps changed ingredient editor catalogue copy and placeholders aligned', function (): void {
    ...
    $expected = [
        ...
        'ingredients.editor.validation.ifra_category_unavailable' => [
            'de' => 'Wähle eine aktive IFRA-Kategorie oder behalte eine in diesem Inhaltsstoff gespeicherte inaktive Kategorie.',
            'es' => 'Elige una categoría IFRA activa o conserva una categoría inactiva ya guardada en este ingrediente.',
            'fr' => 'Choisissez une catégorie IFRA active ou conservez une catégorie inactive déjà enregistrée sur cet ingrédient.',
            'it' => 'Scegli una categoria IFRA attiva oppure conserva una categoria inattiva già salvata su questo ingrediente.',
            'nl' => 'Kies een actieve IFRA-categorie of behoud een inactieve categorie die al op dit ingrediënt is opgeslagen.',
            'pt_BR' => 'Escolha uma categoria IFRA ativa ou mantenha uma categoria inativa já salva neste ingrediente.',
        ],
        ...
        'ingredients.editor.compliance.allergens.add' => [
            'de' => 'Allergen hinzufügen',
            'es' => 'Añadir alérgeno',
            'fr' => 'Ajouter un allergène',
            'it' => 'Aggiungi allergene',
            'nl' => 'Allergeen toevoegen',
            'pt_BR' => 'Adicionar alérgeno',
        ],
        'ingredients.editor.compliance.allergens.concentration' => [
            'de' => 'Konzentration im Inhaltsstoff (%)',
            'es' => 'Concentración en el ingrediente (%)',
            'fr' => 'Concentration dans l’ingrédient (%)',
            'it' => 'Concentrazione nell’ingrediente (%)',
            'nl' => 'Concentratie in ingrediënt (%)',
            'pt_BR' => 'Concentração no ingrediente (%)',
        ],
        'ingredients.editor.compliance.allergens.new_allergen' => [
            'de' => 'Neues Allergen',
            'es' => 'Nuevo alérgeno',
            'fr' => 'Nouvel allergène',
            'it' => 'Nuovo allergene',
        ...
        'ingredients.editor.compliance.allergens.remove' => [
            'de' => 'Allergen entfernen',
            'es' => 'Eliminar alérgeno',
            'fr' => 'Supprimer l’allergène',
            'it' => 'Rimuovi allergene',
            'nl' => 'Allergeen verwijderen',
            'pt_BR' => 'Remover alérgeno',
        ],
        'ingredients.editor.compliance.substances.add' => [
            'de' => 'Substanz hinzufügen',
            'es' => 'Añadir sustancia',
            'fr' => 'Ajouter une substance',
            'it' => 'Aggiungi sostanza',
            'nl' => 'Stof toevoegen',
            'pt_BR' => 'Adicionar substância',
        ],
        'ingredients.editor.compliance.substances.concentration' => [
            'de' => 'Konzentration im Inhaltsstoff (%)',
            'es' => 'Concentración en el ingrediente (%)',
            'fr' => 'Concentration dans l’ingrédient (%)',
            'it' => 'Concentrazione nell’ingrediente (%)',
        ...
        'ingredients.editor.compliance.substances.concentration_helper' => [
            'de' => 'Leer lassen, wenn unbekannt.',
            'es' => 'Déjalo en blanco si se desconoce.',
            'fr' => 'Laissez vide si la valeur est inconnue.',
            'it' => 'Lascia vuoto se sconosciuto.',
            'nl' => 'Laat leeg als het onbekend is.',
            'pt_BR' => 'Deixe em branco se desconhecido.',
        ],
        'ingredients.editor.compliance.substances.new_substance' => [
            'de' => 'Neue Substanz',
            'es' => 'Nueva sustancia',
            'fr' => 'Nouvelle substance',
            'it' => 'Nuova sostanza',
            'nl' => 'Nieuwe stof',
            'pt_BR' => 'Nova substância',
        ],
        'ingredients.editor.compliance.substances.remove' => [
            'de' => 'Substanz entfernen',
            'es' => 'Eliminar sustancia',
            'fr' => 'Supprimer la substance',
            'it' => 'Rimuovi sostanza',
            'nl' => 'Stof verwijderen',
            'pt_BR' => 'Remover substância',
        ],
        'ingredients.editor.compliance.ifra.add_category_limit' => [
            'de' => 'Kategoriegrenzwert hinzufügen',
            'es' => 'Añadir límite de categoría',
            'fr' => 'Ajouter une limite de catégorie',
            'it' => 'Aggiungi limite di categoria',
            'nl' => 'Categorielimiet toevoegen',
            'pt_BR' => 'Adicionar limite de categoria',
        ],
        'ingredients.editor.compliance.ifra.maximum' => [
            'de' => 'Höchstkonzentration (%)',
            'es' => 'Concentración máxima (%)',
            'fr' => 'Concentration maximale (%)',
            'it' => 'Concentrazione massima (%)',
            'nl' => 'Maximale concentratie (%)',
            'pt_BR' => 'Concentração máxima (%)',
        ],
        'ingredients.editor.compliance.ifra.new_category_limit' => [
            'de' => 'Neuer Kategoriegrenzwert',
            'es' => 'Nuevo límite de categoría',
            'fr' => 'Nouvelle limite de catégorie',
            'it' => 'Nuovo limite di categoria',
            'nl' => 'Nieuw categorielimiet',
            'pt_BR' => 'Novo limite de categoria',
        ],
        'ingredients.editor.compliance.ifra.notes' => [
            'de' => 'IFRA-Quellennotizen',
            'es' => 'Notas de la fuente IFRA',
            'fr' => 'Notes de source IFRA',
            'it' => 'Note sulla fonte IFRA',
            'nl' => 'IFRA-bronnotities',
            'pt_BR' => 'Notas da fonte IFRA',
        ],
        'ingredients.editor.compliance.ifra.reference' => [
            'de' => 'Referenzbezeichnung (optional)',
            'es' => 'Etiqueta de referencia (opcional)',
            'fr' => 'Libellé de référence (facultatif)',
            'it' => 'Etichetta di riferimento (facoltativa)',
            'nl' => 'Referentielabel (optioneel)',
            'pt_BR' => 'Rótulo da referência (opcional)',
        ],
        'ingredients.editor.compliance.ifra.remove_category_limit' => [
            'de' => 'Kategoriegrenzwert entfernen',
            'es' => 'Eliminar límite de categoría',
            'fr' => 'Supprimer la limite de catégorie',
            'it' => 'Rimuovi limite di categoria',
            'nl' => 'Categorielimiet verwijderen',
            'pt_BR' => 'Remover limite de categoria',
        ],
...
it('does not ship English placeholders for Inventory translations', function (): void {
    ...
    $languageNeutral = [
        'de:inventory.adjustment.before_after' => 'The stock change contains only placeholders and a language-neutral arrow.',
        ...
        'fr:inventory.adjustment.before_after' => 'The stock change contains only placeholders and a language-neutral arrow.',
        'fr:inventory.adjustment.note' => 'Note is identical in French.',
        ...
        'it:inventory.adjustment.before_after' => 'The stock change contains only placeholders and a language-neutral arrow.',
        'nl:inventory.adjustment.before_after' => 'The stock change contains only placeholders and a language-neutral arrow.',
        'nl:inventory.applied_filter' => 'Filter is the established Dutch loanword.',
        'nl:inventory.filters' => 'Filters is identical in Dutch.',
        'pt_BR:inventory.adjustment.before_after' => 'The stock change contains only placeholders and a language-neutral arrow.',
        ...
        'es:inventory.adjustment.before_after' => 'The stock change contains only placeholders and a language-neutral arrow.',
